    ...
    return (
        <div className="container">
            <div className="row m-6">
                <div className="col-md-8 p-6 border-2">
                    <h1 className="text-justify mb-6" >Welcome To <br /> <span className="text-amber-900 ml-5">Boots Shop</span></h1>
                    <h6 className='text-justify p-1'>We are one of the only places you will find that still measures your feet to help ensure you get that proper fit.  We will help you find shoes to accomodate width requirements, orthotics, or braces.  The Boot Shop is a full service shoe store with a large selection of fine family footwear.  From dress to casual, athletic to slippers and safety, we have it all including accessories like insoles, polishes, laces and so much more.</h6>
                </div>
